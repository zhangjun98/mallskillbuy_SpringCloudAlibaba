...
) ENGINE = InnoDB AUTO_INCREMENT = 8558 CHARACTER SET = utf8 COLLATE = utf8_general_ci COMMENT = '品牌表，一个品牌下有多个商品（spu），一对多关系' ROW_FORMAT = Compact;
...
) ENGINE = InnoDB AUTO_INCREMENT = 77 CHARACTER SET = utf8 COLLATE = utf8_general_ci COMMENT = '商品类目表，类目和商品(spu)是一对多关系，类目与品牌是多对多关系' ROW_FORMAT = Compact;
...
CREATE TABLE `tb_limit_policy`  (
  ...
  `quanty` bigint(20) NULL DEFAULT NULL COMMENT '数量',
  `price` bigint(20) NULL DEFAULT NULL COMMENT '秒杀价格',
...
INSERT INTO `tb_limit_policy` VALUES (22, 26881279030, 15, 15500, '2020-08-22 05:10:00', '2020-08-22 11:55:00');
...
CREATE TABLE `tb_order`  (
  ...
  `promotion_ids` varchar(256) CHARACTER SET utf8 COLLATE utf8_bin NULL DEFAULT '' COMMENT '优惠活动id，多个以，隔开',
  ...
  `source_type` int(1) NULL DEFAULT 2 COMMENT '订单来源：1:app端，2：pc端，3：微信端',
  ...
  INDEX `multi_key_status_time`(`status`, `create_time`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 1172819872783007745 CHARACTER SET = utf8 COLLATE = utf8_bin ROW_FORMAT = Compact;
...
) ENGINE = InnoDB AUTO_INCREMENT = 27 CHARACTER SET = utf8 COLLATE = utf8_general_ci COMMENT = '订单详情表' ROW_FORMAT = Compact;
...
CREATE TABLE `tb_order_logistics`  (
  ...
  `addressee` varchar(32) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL COMMENT '收件人',
  `phone` varchar(11) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL COMMENT '收件人手机号码',
  ...
  `district` varchar(32) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL COMMENT '区',
  `street` varchar(256) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL COMMENT '街道',
  `postcode` int(6) NULL DEFAULT 0 COMMENT '邮编',
  `create_time` timestamp NULL DEFAULT NULL COMMENT '创建时间',
  `update_time` timestamp NULL DEFAULT NULL COMMENT '更新时间',
  PRIMARY KEY (`order_id`) USING BTREE
...
) ENGINE = InnoDB AUTO_INCREMENT = 27359021560 CHARACTER SET = utf8 COLLATE = utf8_general_ci COMMENT = 'sku表,该表表示具体的商品实体,如黑色的 64g的iphone 8' ROW_FORMAT = Compact;
...
) ENGINE = InnoDB AUTO_INCREMENT = 15 CHARACTER SET = utf8 COLLATE = utf8_general_ci COMMENT = '规格参数的分组表，每个商品分类下有多个规格参数组' ROW_FORMAT = Compact;
...
CREATE TABLE `tb_spec_param`  (
  ...
  `unit` varchar(64) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT '' COMMENT '数字类型参数的单位，非数字类型可以为空',
  ...
  INDEX `key_category`(`cid`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 24 CHARACTER SET = utf8 COLLATE = utf8_general_ci COMMENT = '规格参数组下的参数名' ROW_FORMAT = Compact;
...
CREATE TABLE `tb_spu`  (
  ...
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 95 CHARACTER SET = utf8 COLLATE = utf8_general_ci COMMENT = 'spu表，该表描述的是一个抽象性的商品，比如 iphone8' ROW_FORMAT = Compact;
...
CREATE TABLE `tb_stock_storage`  (
  ...
  `sku_id` bigint(20) NOT NULL COMMENT 'skuid',
  `quanty` decimal(18, 2) NULL DEFAULT NULL COMMENT '剩余数量',
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 1172819355075952641 CHARACTER SET = utf8 COLLATE = utf8_general_ci ROW_FORMAT = Compact;
...
CREATE TABLE `tb_stock_storage_history`  (
  ...
  `in_quanty` decimal(18, 2) NULL DEFAULT NULL COMMENT '入库数量',
  `out_quanty` decimal(18, 2) NULL DEFAULT NULL COMMENT '出库数量',
  PRIMARY KEY (`id`) USING BTREE
...
CREATE TABLE `tb_warehouse`  (
  ...
  `name` varchar(64) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL COMMENT '库房名称',
  `create_time` timestamp NULL DEFAULT NULL COMMENT '创建时间',
  `update_time` timestamp NULL DEFAULT NULL COMMENT '更新时间',
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 2 CHARACTER SET = utf8 COLLATE = utf8_general_ci ROW_FORMAT = Compact;
